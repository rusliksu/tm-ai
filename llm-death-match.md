...
| gemini-3.1-pro | `google/gemini-2.5-flash` | downgraded from pro; supports thinking via reasoning param |
| deepseek v4 pro | `deepseek/deepseek-chat` | DeepSeek V3 chat model; no thinking, fast |
...
| Gemini 2.5 Flash | `google/gemini-2.5-flash` | ~$0.30 | ~$1.20 | no | ~$1 |
| DeepSeek Chat (V3) | `deepseek/deepseek-chat` | $0.27 | $1.10 | auto | ~$0.70 |
| **Total** | | | | | **~$6.10/game** |
